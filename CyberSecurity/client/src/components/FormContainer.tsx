...
function FormContainer(props: FormInterface) {
    ...
    return (
        <div className='my-20 h-fit p-4 py-6 flex flex-col items-center border border-neutral-2 rounded-2xl shadow-xl w-[90%] max-w-md md:max-w-lg lg:max-w-2xl font-body text-regular-grey gap-2'>
